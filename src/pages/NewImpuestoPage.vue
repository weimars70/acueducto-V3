...
import type { CreateImpuestoDto } from '../types/impuesto';
...
const form = ref<CreateImpuestoDto>({
  nombre: '',
...
const handleSubmit = async () => {
  try {
    loading.value = true;
    await impuestoService.create(form.value);
    $q.notify({
      type: 'positive',
        ...
        <div class="header-content">
          <div class="title-section">
            ...
            <div>
              ...
              <p class="page-subtitle">Crear un nuevo impuesto</p>
            </div>
          </div>
        </div>
      </div>
