...
const handleSubmit = async () => {
  ...
  try {
    loading.value = true;
    await periodoNominaService.create(formData.value);
    $q.notify({
      type: 'positive',
    ...
    const message = error?.response?.data?.message || error?.message || 'Error al crear el período de nómina';
    $q.notify({
      type: 'negative',
      message
    });
      ...
      <div class="form-header">
        ...
        <div class="header-content">
          ...
          <div class="header-text">
            <h1 class="form-title">Nuevo Período de Nómina</h1>
            <p class="form-subtitle">Complete la información del período de liquidación</p>
          </div>
        </div>
      </div>
            ...
            <div class="row q-col-gutter-md">
              ...
              <div class="col-12 col-md-6">
                <div class="input-wrapper">
                  ...
                  <div class="hint-text">Por defecto: ABIERTO</div>
                </div>
              </div>
            </div>
          </div>
