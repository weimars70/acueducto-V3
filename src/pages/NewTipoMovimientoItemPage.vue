...
const handleSubmit = async () => {
  try {
    ...
    await tipoMovimientoItemService.create({
      ...
      <div class="page-header">
        <div class="header-content">
          <div class="title-section">
            ...
            />
            <div>
              <h1 class="page-title">Nuevo Tipo de Movimiento</h1>
              <p class="page-subtitle">Crear un nuevo tipo de movimiento de item</p>
            </div>
          </div>
        </div>
      </div>
