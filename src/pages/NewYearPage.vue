...
import type { CreateYearsDto } from '../types/years';
...
const formData = ref<CreateYearsDto>({
...
const handleSubmit = async () => {
  ...
  try {
    loading.value = true;
    await yearsService.create(formData.value);
    $q.notify({
      type: 'positive',
    ...
    const message = error?.response?.data?.message || error?.message || 'Error al crear el año';
    $q.notify({
      type: 'negative',
      message
    });
      ...
      <div class="form-header">
        ...
        <div class="header-content">
          ...
          <div class="header-text">
            <h1 class="form-title">Nuevo Año</h1>
            <p class="form-subtitle">Registre un nuevo año fiscal</p>
          </div>
        </div>
      </div>
