...
import type { UpdateNotaDebitoConceptoDto } from '../types/nota-debito-concepto';
...
const formData = ref<UpdateNotaDebitoConceptoDto>({
  descripcion: ''
});

const loadData = async () => {
    try {
        const data = await notaDebitoConceptoService.getById(codigo);
        formData.value = {
...
const handleSubmit = async () => {
  ...
  try {
    loading.value = true;
    await notaDebitoConceptoService.update(codigo, formData.value);
    ...
    <div class="row justify-center">
      <div class="col-12 col-md-8 col-lg-6">
        ...
        <div class="text-center q-mb-lg">
             <div class="text-h5 text-weight-bold text-primary">Editar Concepto de Nota Débito</div>
