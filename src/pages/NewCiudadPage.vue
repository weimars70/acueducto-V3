...
import type { CreateCiudadDto } from '../types/ciudad';
...
const formData = ref<CreateCiudadDto>({
  codigo: '',
  nombre: '',
...
const handleSubmit = async () => {
  ...
  try {
    loading.value = true;
    await ciudadService.create(formData.value);
    $q.notify({
      type: 'positive',
    ...
    const message = error?.response?.data?.message || error?.message || 'Error al crear la ciudad';
    $q.notify({
      type: 'negative',
      message
    });
      ...
      <div class="form-header">
        ...
        <div class="header-content">
          ...
          <div class="header-text">
            <h1 class="form-title">Nueva Ciudad</h1>
            <p class="form-subtitle">Complete la información de la ciudad</p>
          </div>
        </div>
      </div>
