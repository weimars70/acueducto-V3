  ...
  <q-page class="page-container">
    <div class="form-card">
      ...
      <div class="form-header">
        ...
        <div>
          <p class="form-title">Registrar nueva instalación en el sistema</p>
        </div>
      </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await instalacionesService.create(instalacionData);
    ...
    $q.notify({
      type: 'negative',
      message: error.response?.data?.message || error.message || 'Error al crear instalación',
      position: 'top'
    });
  } finally {
    loading.value = false;
