...
import type { UpdateImpuestoDto } from '../types/impuesto';
...
const form = ref<UpdateImpuestoDto & { id?: number }>({
  nombre: '',
...
const loadData = async () => {
  try {
    ...
    const impuesto = await impuestoService.getById(id);
    form.value = {
      id: impuesto.id,
    ...
    $q.notify({
      type: 'negative',
      message: 'Error al cargar el impuesto'
    });
    router.push('/impuestos');
  } finally {
...
const handleSubmit = async () => {
  try {
    ...
    const updateData: UpdateImpuestoDto = {
      nombre: form.value.nombre,
      porcentaje: form.value.porcentaje,
      usuario: form.value.usuario
    };
    await impuestoService.update(id, updateData);
    $q.notify({
      type: 'positive',
        ...
        <div class="header-content">
          <div class="title-section">
            ...
            <div>
              ...
              <p class="page-subtitle">Actualizar información del impuesto</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <q-card-section>
            ...
            <div class="form-section">
              <div class="section-header">
                ...
                <span class="section-title">Información del Impuesto</span>
              </div>
              ...
              <div class="form-grid">
                ...
                <div class="form-field full-width">
                  ...
                  <q-input
                    ...
                    outlined
                    dense
                    placeholder="Ingrese el porcentaje (opcional)"
                    step="0.01"
                    min="0"
                    class="modern-input"
                  >
